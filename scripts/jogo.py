...
class Jogo:
    def __init__(self):
        ...
        self.bg = Obj(bg, 0, 0)
        self.bg2 = Obj(bg, 0, -640)
        self.aranha = Obj(aranha, random.randrange(0, 290), -50)
        self.flor = Obj(flor,random.randrange(0, 290), -50)
        self.abelha = Abelha(abelha, 150, 500)
    ...
    def mov_aranha(self):
        ...
        if self.aranha.sprite.rect[1] >= 700:
            ...
            self.aranha = Obj(aranha, random.randrange(0, 299), -50)
    ...
    def mov_flor(self):
        ...
        if self.flor.sprite.rect[1] >= 700:
            ...
            self.flor = Obj(flor, random.randrange(0, 299), -50)
